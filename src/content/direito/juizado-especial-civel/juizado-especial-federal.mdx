...
* A perícia é comum em ações previdenciárias e assistenciais
...
* `RPV` - Requisição de Pequeno Valor para pagamento de quantia devida
...
* Pagamento de valores atrasados → Expedição de RPV, quando cabível
